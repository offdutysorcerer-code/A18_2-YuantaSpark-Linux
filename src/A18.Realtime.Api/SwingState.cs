...
internal sealed record SwingBrowseState(string Symbol="2330", string Date="", string Interval="5", bool Overlay=false, bool MultiDay=false, int LookbackDays=1, string Group="", bool ShowSectionNumbers=true);
